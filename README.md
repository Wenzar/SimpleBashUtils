...
В этом проекте реализованы базовые утилиты Bash по работе с текстами на языке программирования Си. Эти утилиты (cat и grep) достаточно часто используются при работе в терминале Linux. Реализация вклучает покрытие интеграционными тестами.
